...
struct RgbwwColor : RgbColorBase
{
    ...
    // ------------------------------------------------------------------------
    RgbwwColor(uint8_t r, uint8_t g, uint8_t b, uint8_t warmW = 0, uint8_t coolW = 0) : R(r), G(g), B(b), WW(warmW), CW(coolW) {
                                                                                        };
    ...
    // ------------------------------------------------------------------------
    RgbwwColor(uint8_t brightness) : R(0), G(0), B(0), WW(brightness), CW(brightness) {
                                     };

    // ------------------------------------------------------------------------
    // Construct a RgbwwColor using RgbColor
    // ------------------------------------------------------------------------
    RgbwwColor(const RgbColor &color) : R(color.R),
                                        G(color.G),
                                        B(color.B),
                                        WW(0),
                                        CW(0) {
    ...
    // ------------------------------------------------------------------------
    RgbwwColor(const RgbwColor &color) : R(color.R),
                                         G(color.G),
                                         B(color.B),
                                         WW(color.W),
                                         CW(color.W) {
