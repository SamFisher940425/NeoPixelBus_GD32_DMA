...
struct Rgbww80Color : RgbColorBase
{
    ...
    // ------------------------------------------------------------------------
    Rgbww80Color(uint16_t r, uint16_t g, uint16_t b, uint16_t warmW = 0, uint16_t coolW = 0) : R(r), G(g), B(b), WW(warmW), CW(coolW) {
                                                                                               };
    ...
    // ------------------------------------------------------------------------
    Rgbww80Color(uint16_t brightness) : R(0), G(0), B(0), WW(brightness), CW(brightness) {
                                        };
    ...
    // ------------------------------------------------------------------------
    Rgbww80Color(const Rgb48Color &color) : R(color.R),
                                            G(color.G),
                                            B(color.B),
                                            WW(0),
                                            CW(0) {
