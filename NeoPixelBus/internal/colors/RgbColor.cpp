...
RgbColor::RgbColor(const RgbwColor &color) : R(color.R),
                                             G(color.G),
                                             B(color.B) {
                                             };

RgbColor::RgbColor(const RgbwwColor &color) : R(color.R),
                                              G(color.G),
                                              B(color.B) {
                                              };

RgbColor::RgbColor(const RgbwwwColor &color) : R(color.R),
                                               G(color.G),
                                               B(color.B) {
                                               };

RgbColor::RgbColor(const Rgb48Color &color) : R(color.R >> 8),
                                              G(color.G >> 8),
                                              B(color.B >> 8) {
                                              };

RgbColor::RgbColor(const Rgbw64Color &color) : R(color.R >> 8),
                                               G(color.G >> 8),
                                               B(color.B >> 8) {
                                               };

RgbColor::RgbColor(const Rgbww80Color &color) : R(color.R >> 8),
                                                G(color.G >> 8),
                                                B(color.B >> 8) {
                                                };
